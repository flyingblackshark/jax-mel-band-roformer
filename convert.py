...
def load_params():
    ...
    for i in range(60):
        ...
        params[f"MaskEstimator_0.to_freqs_{i}.layers_0.layers_4.kernel"]=state_dict[f"mask_estimators.0.to_freqs.{i}.0.4.weight"].transpose(0,1)
        params[f"MaskEstimator_0.to_freqs_{i}.layers_0.layers_4.bias"]=state_dict[f"mask_estimators.0.to_freqs.{i}.0.4.bias"]
        # params[f"MaskEstimator_0.to_freqs_{i}.layers_0.layers_0.kernel"]=state_dict[f"mask_estimators.0.to_freqs.{i}.0.0.weight"].transpose(0,1)
        # params[f"MaskEstimator_0.to_freqs_{i}.layers_0.layers_0.bias"]=state_dict[f"mask_estimators.0.to_freqs.{i}.0.0.bias"]
        # params[f"MaskEstimator_0.to_freqs_{i}.layers_0.layers_2.kernel"]=state_dict[f"mask_estimators.0.to_freqs.{i}.0.4.weight"].transpose(0,1)
        # params[f"MaskEstimator_0.to_freqs_{i}.layers_0.layers_2.bias"]=state_dict[f"mask_estimators.0.to_freqs.{i}.0.4.bias"]
    for i in range(6):
        #for j in range(2):
